...
SVNURL="http://plugins.svn.wordpress.org/payfort/" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="jamesmay" # your svn username
...
# Check for subversion (this only works in Ubuntu :/ )
